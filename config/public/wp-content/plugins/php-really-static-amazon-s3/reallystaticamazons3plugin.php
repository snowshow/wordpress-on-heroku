...
add_action("rs-aboutyourplugin",create_function('','echo "<b>Amazon-S3 (v0.1):</b> S3-Class programmed by Donovan Schönknecht; Really-static implimentation by Erik Sefkow.<br>";'));
...
$transportfuntions[amazons3]=array("rs_amazons3_connect","rs_amazons3_disconnect",
	"rs_amazons3_writefile",
	"rs_amazons3_deletefile",
	"rs_amazons3_writecontent",
	"rs_amazons3_isconnected",
	"rs_amazons3_saveoptions",
	
	
	
	"rs_amazons3_remoteurl",
	"rs_amazons3_remotetemplateurl",
	"rs_amazons3_settingstoarray",
	"rs_amazons3_arraytosettings",

	"rs_amazons3_install",
	"rs_amazons3_uninstall",
	"rs_amazons3_upgrade"
...
function rs_amazons3_remoteurl(){
	#if(get_option("rs_differentpaths")==true){
	#	return loaddaten ( "rs_amazons3_remoteurl");
	#}else 
	return loaddaten ( "rs_remoteurl" );

}
function rs_amazons3_remotetemplateurl(){
#	if(get_option("rs_differentpaths")==true){
#		return loaddaten ( "rs_amazons3_remotetemplateurl");
	#}else 
	return loaddaten ( "rs_designremote");
...
function rs_amazons3_settingstoarray(){
	return array(
	"rs_s3bucket"=>get_option('realstaticamazons3bucket'),
	"rs_s3accessKey"=>get_option('realstaticamazons3accessKey'),
	"rs_s3secretKey"=>get_option('realstaticamazons3secretKey'),
	"rs_s3remotepath"=>get_option('realstaticamazons3remotepath'),
	"rs_s3remoteurl"=>get_option('rs_amazons3_remoteurl'),
	"rs_s3remotetemplateurl"=>get_option('rs_amazons3_remotetemplateurl')
	);

}
function rs_amazons3_arraytosettings($array){
	update_option('realstaticamazons3bucket',$array["rs_s3bucket"]);
	update_option('realstaticamazons3accessKey',$array["rs_s3accessKey"]);
	update_option('realstaticamazons3secretKey',$array["rs_s3secretKey"]);
	update_option('realstaticamazons3remotepath',$array["rs_s3remotepath"]);
	update_option('rs_amazons3_remoteurl',$array["rs_s3remoteurl"]);
	update_option('rs_amazons3_remotetemplateurl',$array["rs_s3remotetemplateurl"]);
...
function rs_amazons3_install(){
	add_option('realstaticamazons3bucket', "", '', 'yes' );
	add_option('realstaticamazons3accessKey', "", '', 'yes' );
	add_option('realstaticamazons3secretKey', "", '', 'yes' );
	add_option('realstaticamazons3remotepath', "", '', 'yes' );
	add_option('rs_amazons3_remoteurl',"", '', 'yes' );
	add_option('rs_amazons3_remotetemplateurl',"", '', 'yes' );
}
function rs_amazons3_uninstall(){
	delete_option('realstaticamazons3bucket');
	delete_option('realstaticamazons3accessKey');
	delete_option('realstaticamazons3secretKey');
	delete_option('realstaticamazons3remotepath');
	delete_option('rs_amazons3_remoteurl');
	delete_option('rs_amazons3_remotetemplateurl');
}
function rs_amazons3_upgrade($aktuelleversion){
